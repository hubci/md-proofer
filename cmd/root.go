...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.md-proofer.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".md-proofer" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".md-proofer")
	}
